  ...
  return (
    ...
    <div className="text-white p-5 w-full">
      <div className="bg-secondary w-full p-5 rounded-md">
        ...
        <div className="mt-10">
          <form onSubmit={ handleSubmit(upload)} className="flex flex-col items-start gap-5 justify-start">
            
            <div className="w-full">
            <div>
            <FormElements.Label withAsterisk>Category Name</FormElements.Label>
            <Controller
              name="categoryname"
              control={control}
              render={({ field }) => (
            ...
            />
            <FormElements.Error>{errors.categoryname?.message}</FormElements.Error>
          </div>
            </div>
            <div className="w-full">
            <div>
            <FormElements.Label withAsterisk>Category Description</FormElements.Label>
            <Controller
              name="description"
              control={control}
              render={({ field }) => (
            ...
            />
            <FormElements.Error>{errors.description?.message}</FormElements.Error>
          </div>
            </div>
            {image && (
            ...
            <div className="flex gap-5 items-center mt-10 justify-center">
              ...
              <Button variant="danger">CANCEL</Button> {/* Corrected 'denger' to 'danger' */}
            </div>
          </form>
        </div>
      </div>
